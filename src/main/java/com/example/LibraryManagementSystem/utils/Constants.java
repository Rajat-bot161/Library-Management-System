...
public class Constants {
    ...
    public static String STUDENT_SELF_INFO_AUTHORITY = "STUDENT_SELF_INFO";

    public static String STUDENT_INFO_AUTHORITY = "STUDENT_INFO";

    public static String MAKE_PAYMENT_AUTHORITY = "MAKE_PAYMENT";
